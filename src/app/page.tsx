        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full relative z-10">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a href="https://www.linkedin.com/in/saran-r-b2b1a5275/" target="_blank" rel="noopener noreferrer" className="group p-3 bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg text-gray-400 hover:text-blue-300 hover:border-blue-400/50 transition-all duration-300 transform hover:scale-110">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <div className="group relative bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 hover:border-purple-400/50 transition-all duration-300 hover:bg-slate-800/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('https://drive.google.com/file/d/1WhxCnwiHSbOMmePQ-L7Yf2xHfURCIbFc/view', '_blank')}
            ...
            <div className="group relative bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 hover:border-blue-400/50 transition-all duration-300 hover:bg-slate-800/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/T6kdcdKSTfg2aotxT/hzmoNKtzvAzXsEqx8_T6kdcdKSTfg2aotxT_qzDS3fCN9ThbDFmSR_1742738755749_completion_certificate.pdf', '_blank')}
            ...
            <div className="group relative bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 hover:border-red-400/50 transition-all duration-300 hover:bg-slate-800/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/ifobHAoMjQs9s6bKS/gmf3ypEXBj2wvfQWC_ifobHAoMjQs9s6bKS_qzDS3fCN9ThbDFmSR_1742738755362_completion_certificate.pdf', '_blank')}
            ...
            <div className="group relative bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 hover:border-green-400/50 transition-all duration-300 hover:bg-slate-800/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('https://forage-uploads-prod.s3.amazonaws.com/completion-certificates/ifobHAoMjQs9s6bKS/MyXvBcppsW2FkNYCX_ifobHAoMjQs9s6bKS_qzDS3fCN9ThbDFmSR_1742738755009_completion_certificate.pdf', '_blank')}
            ...
            <div className="group relative bg-slate-800/30 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 hover:border-yellow-400/50 transition-all duration-300 hover:bg-slate-800/50">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => window.open('https://inspiration-fun-7467.my.salesforce-sites.com/CDACcertificatePage2?id=a02Vy0000030JW4IAM', '_blank')}
